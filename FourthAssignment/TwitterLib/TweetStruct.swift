...
public struct TweetStruct : CustomStringConvertible
{
    ...
    init?(data: NSDictionary?)
    {
        ...
        self.media = TweetStruct.mediaItems(from: data?.array(forKeyPath: TwitterKey.media))
        self.hashtags = TweetStruct.mentions(from: data?.array(forKeyPath: TwitterKey.Entities.hashtags), in: text, with: "#")
        self.urls = TweetStruct.mentions(from: data?.array(forKeyPath: TwitterKey.Entities.urls), in: text, with: "http")
        self.userMentions = TweetStruct.mentions(from: data?.array(forKeyPath: TwitterKey.Entities.userMentions), in: text, with: "@")
    }
...
public struct Mention: CustomStringConvertible
{
    ...
    {
        guard
            let indices = data?.array(forKeyPath: TweetStruct.TwitterKey.Entities.indices),
        ...
        if let mention = data?.string(forKeyPath: TweetStruct.TwitterKey.Entities.text) {
